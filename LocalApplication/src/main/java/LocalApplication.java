    ...
    public static void main(String[] argv){
        try {
            ...
            createBucket(s3, bucketName);
                String key_name = "InputFile" + new Timestamp(System.currentTimeMillis()) + ProcessHandle.current().pid();
            ...
            String queueName = "malqueue" + ProcessHandle.current().pid();
            String msgBody = bucketName + "$" + key_name + "$" + queueName;
